...
Based on Polaris Resolver for Tron and EVM chains.

## Goal

To enable trustless cross-chain swaps between EVM chains and Tron Network through HTLCs and intent-based architecture, without the need to rely on centralized bridges or forgo access to these blockchain ecosystems entirely.
...
▼                                       ▼                                       ▼
┌─────────────────┐             ┌─────────────────┐             ┌─────────────────┐
│   Tron Network  │             │ EVM Blockchains │             │ Automated Market│
│                 │             │                 │             │     Makers      │
├─────────────────┤             ├─────────────────┤             ├─────────────────┤
│                 │             │                 │             │                 │
